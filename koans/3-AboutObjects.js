describe("3. About Objects", () => {
  ...
  it("should use prototype to add to all objects", () => {
    ...
    Circle.prototype.describe = () => {console.log(this);
...
// arrow functions do not have this. If this is accessed,
// it is taken from the outside. Hence the undefined for radius
  it("should create your own simple object", () => {
    const myNewObject = {prop1: 'a property!', prop2: [4,3,2],
     prop3: function() {return 'a property that is a method!'}
  }
